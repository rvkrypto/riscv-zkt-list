...
_security by design_ can usually be achieved via conscious implementation of
relevant iterative multi-cycle instructions or instructions composed of
micro-ops to avoid data-dependant latency.
